...
import utils from "sypht-node-client/lib/utils";
import fs from "fs";
...
class CustomSypht {
     ...
     */
    constructor(options) {
        const arr = utils.processAPIKey(options.apiKey);
        this.clientId = arr[0];
...
export default new CustomSypht({apiKey: process.env.SYPHT_API_KEY});
